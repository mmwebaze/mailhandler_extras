...
/**
 * An extra entity type and bundle analyzer.
 *
 * @ingroup analyzer
 *
 ...
 *
 * @Analyzer(
 *   id = "extra_entity_type",
 *   label = @Translation("Extra Entity type and bundle Analyzer")
 * )
 */
class ExtraEntityTypeAnalyzer extends AnalyzerBase{
  /**
   * {@inheritdoc}
   */
