<?php
namespace Drupal\mailhandler_extras\Plugin\inmail\Handler;
...
/**
 * An extra message handler that supports posting comments via email.
 *
 ...
 *
 * @Handler(
 *   id = "extramailhandler_comment",
 *   label = @Translation("Comment extra"),
 *   description = @Translation("Post comments via email.")
 * )
 */
class ExtraMailhandlerComment extends HandlerBase implements ContainerFactoryPluginInterface {
  /**
